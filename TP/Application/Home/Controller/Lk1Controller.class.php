...
class Lk1Controller extends Controller {
    ...
    public function index2(){
        $this->display('Home/index2');
    }
    public function index3(){
        $this->display('Home/index3');
    }
    public function lkone(){
        $this->display('Home/lkone');
    }
    public function lktwo(){
        $this->display('Home/lktwo');
    }
    public function lktheer(){
        $this->display('Home/lktheer');
    }
    public function lkfour(){
        $this->display('Home/lkfour');
    }
    public function lkfive(){
        $this->display('Home/lkfive');
    }
    public function lksix(){
        $this->display('Home/lksix');
    }
    public function lkseven(){
        $this->display('Home/lkseven');
    }
    public function lkeight(){
        $this->display('Home/lkeight');
    }
    public function lknane(){
        $this->display('Home/lknane');
    }
    public function lkten(){
        $this->display('Home/lkten');
    }
    public function six(){
        $this->display('Home/six');
    }
    public function nane(){
        $this->display('Home/nane');
    }
    public function lk(){
        $this->display('Home/lk');
    }
    public function ten(){
    ...
    public function paizhao(){
        $this->display('Home/paizhao');
    }
    public function shouhui(){
        $this->display('Home/shouhui');
    }
    public function huodongbaoming(){
        $this->display('Home/huodongbaoming');
    }
    public function tongji(){
        $this->display('Home/tongji');
    }
    public function ibaecon(){
        $this->display('Home/ibaecon');
    }
    public function qiandao(){
        $this->display('Home/qiandao');
    }
    public function qianyue(){
        $this->display('Home/qianyue');
    }
    public function danmu(){
        $this->display('Home/danmu');
    }
    public function baping(){
        $this->display('Home/baping');
    }
    public function weixin(){
    $this->display('Home/weixin');
    }
    public function toupiao(){
        $this->display('Home/toupiao');
    }
    public function duiduipeng(){
        $this->display('Home/duiduipeng');
    }
    public function danmu2(){
        $this->display('Home/danmu2');
    }
    public function shibie(){
        $this->display('Home/shibie');
    }
