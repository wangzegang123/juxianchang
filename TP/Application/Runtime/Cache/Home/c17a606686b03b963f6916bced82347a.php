    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-9 col-lg-10 sys_menu_box">
                ...
                <div class="panel-body withdrawals-box">
                    <div class="tool-bar bg-white border-radus clearfix pd-20">
                        ...
                        <div class="tip-account pull-right help-info">
                            ...
                            <div style="margin-top:30px;"><a class="btn btn-success pull-left" href="./index.php?c=site&amp;a=entry&amp;op=cz&amp;do=redpack_wallet&amp;m=meepo_xianchang">立即充值</a></div>
                        </div>
                    </div>
                </div>
            </div>
            <form action="" method="post" class="form-horizontal" role="form" ng-controller="formCtrl" id="form2">
                <div class="panel panel-default">
                    <div class="panel-heading">红包发放明细</div>
                    <div class="panel-body">
                        <table class="table table-hover" style="display:auto;">
                            <thead class="navbar-inner">
                            <tr>
                                <th style="width:50%;text-align:center">活动名称</th>
                                <th style="width:50%;text-align:center">详细</th>
                            </tr>
                            </thead>
                            <tbody>
