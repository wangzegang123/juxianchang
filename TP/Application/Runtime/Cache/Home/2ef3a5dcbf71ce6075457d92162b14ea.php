...
<div class="wrap" id="wrap"> 
  ...
  <div class="inner2 location clearfix">
    <div class="left">
     <a href="http://www.juxianchang.com/wxfunction/">功能服务</a> &gt; <a href="http://www.juxianchang.com/wxfunction/hudong/">互动</a> &gt;   <a href="http://www.juxianchang.com/wxfunction/hudong/46.html">幸运大转盘</a> 
    </div>
  ...
  <div class="inner2">
    <div class="column2 clearfix">
      <div class="column2-pic left js_funcPic">
        <div id="js_funcPicBig" class="swiper-container  gallery-top">
          ...
          <ul class="swiper-wrapper column2-pic-big">
                        <li class="swiper-slide"><img src="/Public/Home/images/20170430061504921.png"></li>
                      </ul>
        </div>
      ...
      <div class="column2-con left">
        <h3>幸运大转盘 </h3>
        <p>【看看如何使用】此项应用特针对——幸运中的幸运用户快速参与：选出幸运观众，点击开始大转盘转动，随机抽出奖品用户扫描参与：可选取指定</p>
    ...
    <div class="clearfix">
      ...
      <div class="detail right">
          ...
          <ul class="left">
            <li><a href="http://www.juxianchang.com/wxfunction/hudong/46.html#jsDetailIntro">详情介绍</a></li>
      ...
      <div id="jsDetailIntro" class="detail-con">
          <div class="txt">
           <p style="padding: 0px; margin-top: 0px; margin-bottom: 0px; font-family: &#39;Microsoft yahei&#39;, Arial, Helvetica, sans-serif; font-size: 14px; white-space: normal; text-align: center; background-color: rgb(255, 255, 255);"><span style="padding: 0px; margin: 0px; font-size: 18px;">【看看如何使用】</span></p><p style="padding: 0px; margin-top: 0px; margin-bottom: 0px; font-family: &#39;Microsoft yahei&#39;, Arial, Helvetica, sans-serif; font-size: 14px; white-space: normal; text-align: center; background-color: rgb(255, 255, 255);"><span style="padding: 0px; margin: 0px; font-size: 18px;">此项应用特针对——幸运中的幸运用户</span></p><p style="padding: 0px; margin-top: 0px; margin-bottom: 0px; font-family: &#39;Microsoft yahei&#39;, Arial, Helvetica, sans-serif; font-size: 14px; white-space: normal; text-align: center; background-color: rgb(255, 255, 255);"><span style="padding: 0px; margin: 0px; font-size: 18px;"><br style="padding: 0px; margin: 0px;"></span></p><p style="padding: 0px; margin-top: 0px; margin-bottom: 0px; font-family: &#39;Microsoft yahei&#39;, Arial, Helvetica, sans-serif; font-size: 14px; white-space: normal; text-align: center; background-color: rgb(255, 255, 255);"><span style="padding: 0px; margin: 0px; font-size: 18px;">快速参与：选出幸运观众，点击开始大转盘转动，随机抽出奖品</span></p><p style="padding: 0px; margin-top: 0px; margin-bottom: 0px; font-family: &#39;Microsoft yahei&#39;, Arial, Helvetica, sans-serif; font-size: 14px; white-space: normal; text-align: center; background-color: rgb(255, 255, 255);"><span style="padding: 0px; margin: 0px; font-size: 18px;">用户扫描参与：可选取指定用户扫描二维码参与，抽取大奖</span></p><p style="padding: 0px; margin-top: 0px; margin-bottom: 0px; font-family: &#39;Microsoft yahei&#39;, Arial, Helvetica, sans-serif; font-size: 14px; white-space: normal; text-align: center; background-color: rgb(255, 255, 255);"><span style="padding: 0px; margin: 0px; font-size: 18px;"><br style="padding: 0px; margin: 0px;"></span></p><p style="padding: 0px; margin-top: 0px; margin-bottom: 0px; font-family: &#39;Microsoft yahei&#39;, Arial, Helvetica, sans-serif; font-size: 14px; white-space: normal; text-align: center; background-color: rgb(255, 255, 255);"><span style="padding: 0px; margin: 0px; font-size: 18px;">如：活动中已选中几位特定的幸运观众</span></p><p style="padding: 0px; margin-top: 0px; margin-bottom: 0px; font-family: &#39;Microsoft yahei&#39;, Arial, Helvetica, sans-serif; font-size: 14px; white-space: normal; text-align: center; background-color: rgb(255, 255, 255);"><span style="padding: 0px; margin: 0px; font-size: 18px;">幸运观众上台后再进行大转盘抽奖</span></p><p></p><section class="tn-Powered-by-XIUMI" style="padding: 0px; margin: 0.5em 0.3em; font-family: &#39;Microsoft yahei&#39;, Arial, Helvetica, sans-serif; font-size: 14px; white-space: normal; border: none; box-sizing: border-box; background-color: rgb(255, 255, 255);"><section class="tn-Powered-by-XIUMI" style="padding: 0px; margin: 0px; text-align: center; border-color: rgb(8, 187, 84); box-sizing: border-box; background-color: transparent !important;"><section class="tn-Powered-by-XIUMI" style="padding: 0px; margin: 12px 0px 0px; display: inline-block; vertical-align: top; width: 205.516px; border: 1px solid rgb(8, 187, 84); box-sizing: border-box;"></section></section></section><p></p><p><br></p>		   </div>
        </div>
...
<a href="http://www.juxianchang.com/wxfunction/hudong/46.html#top" id="scrollUp"></a>
<script>
var companyId = 0;
