...
<div class="wrap" id="wrap" >
        ...
        <div class="column2-pic left js_funcPic">
            <div id="js_funcPicBig" class="swiper-container  gallery-top">
                ...
                <ul class="swiper-wrapper column2-pic-big">
                    <li class="swiper-slide"><img src="/Public/Home/images/20161005103444728.png"></li>
                </ul>
            </div>
    ...
    <div class="detail right">
        ...
        <div id="jsDetailIntro" class="detail-con">
            <div class="txt">
                <p>微信邀请函：例如请帖、喜帖、普通电子邀请函等</p><p style="padding: 0px; margin: 0px; color: rgb(0, 0, 0); font-family: &#39;Microsoft yahei&#39;, Arial, Helvetica, sans-serif; font-size: 14px; text-align: center;">&nbsp;</p><p style="padding: 0px; margin: 0px; color: rgb(0, 0, 0); font-family: &#39;Microsoft yahei&#39;, Arial, Helvetica, sans-serif; font-size: 14px; text-align: center;"><span style="padding: 0px; margin: 0px; color: #FF0000; font-size: 24px;">&nbsp;更多需求，详情请咨询客服。</span></p>		   </div>
        </div>
