...
<div class="wrap" id="wrap"> 
  ...
  <div class="inner2 location clearfix">
    <div class="left">
     <a href="http://www.juxianchang.com/wxfunction/">功能服务</a> &gt; <a href="http://www.juxianchang.com/wxfunction/hudong/">互动</a> &gt;   <a href="http://www.juxianchang.com/wxfunction/hudong/11.html">弹幕</a> 
    </div>
  ...
  <div class="inner2">
    <div class="column2 clearfix">
      <div class="column2-pic left js_funcPic">
        <div id="js_funcPicBig" class="swiper-container  gallery-top">
          ...
          <ul class="swiper-wrapper column2-pic-big">
                        <li class="swiper-slide"><img src="/Public/Home/images/1498870941.gif"></li>
                      </ul>
        </div>
      ...
      <div class="column2-con left">
        <h3>弹幕 </h3>
        <p>所有审核上墙的消息会以弹幕的形式飞过同时消息也会显示在消息墙上</p>
        <p class="price">￥<span>200元起/天</span></p>
		  <p style="display: block; font-size: 12px; color:red;text-decoration: line-through; margin: -3px 0 0;"><span></span></p>
    <div class="tag">
		                 <li><a href="http://www.juxianchang.com/wxfunction/hudong/11.html#" target="_blank">组合使用 200元</a></li>
				        <li><a href="http://www.juxianchang.com/wxfunction/hudong/11.html#" target="_blank">单独使用 300元</a></li>
				        <li><a href="http://www.juxianchang.com/wxfunction/hudong/11.html#" target="_blank">高级全时弹幕 1500元</a></li>
    ...
    <div class="clearfix">
      ...
      <div class="detail right">
          ...
          <ul class="left">
            <li><a href="http://www.juxianchang.com/wxfunction/hudong/11.html#jsDetailIntro">详情介绍</a></li>
      ...
      <div id="jsDetailIntro" class="detail-con">
          <div class="txt">
           <p><span style="font-size: 18px; color: #7D7D7D; font-family: &#39;Microsoft yahei&#39;, Arial, Helvetica, sans-serif; line-height: 26px; text-align: center;"><br></span></p><p><br></p><p style="text-align: center;"><span style="font-size: 18px; color: #7D7D7D; font-family: &#39;Microsoft yahei&#39;, Arial, Helvetica, sans-serif; line-height: 26px; text-align: center;"><strong style="color: rgb(0, 176, 80); font-size: 36px; text-align: center; white-space: normal;"><span style="font-family: &#39;Microsoft yahei&#39;, Arial, Helvetica, sans-serif; line-height: 26px;">高级弹幕效果</span></strong></span></p><p style="text-align: center;"><span style="color: #7D7D7D; font-family: &#39;Microsoft yahei&#39;, Arial, Helvetica, sans-serif; line-height: 26px; text-align: center; font-size: 18px;">此弹幕可应用到任何场景下、不管你是在放视频、PPT、直播</span></p><p style="text-align: center;"><span style="color: #7D7D7D; font-family: &#39;Microsoft yahei&#39;, Arial, Helvetica, sans-serif; line-height: 26px; text-align: center; font-size: 18px;">无缝植入到任意场景下，不需要额外的投影设备</span></p><p style="text-align: center;"><span style="color: #7D7D7D; font-family: &#39;Microsoft yahei&#39;, Arial, Helvetica, sans-serif; line-height: 26px; text-align: center; font-size: 18px;"><span style="color: #7D7D7D; font-family: &#39;Microsoft yahei&#39;, Arial, Helvetica, sans-serif; font-size: 18px; line-height: 26px; text-align: center;">所有审核上墙的消息会以弹幕的形式飞过！</span></span></p><p><span style="font-size: 18px; color: #7D7D7D; font-family: &#39;Microsoft yahei&#39;, Arial, Helvetica, sans-serif; line-height: 26px; text-align: center;"><img src="/Public/Home/images/14813747151.png" alt="超级弹幕.gif"></span></p><p><span style="font-size: 18px; color: #7D7D7D; font-family: &#39;Microsoft yahei&#39;, Arial, Helvetica, sans-serif; line-height: 26px; text-align: center;"><br></span></p><p style="text-align: center;"><span style="color: #00B050; font-size: 36px;"><strong><span style="color: #00B050; font-family: &#39;Microsoft yahei&#39;, Arial, Helvetica, sans-serif; line-height: 26px; text-align: center;">普通弹幕效果</span></strong></span></p><p><span style="font-size: 18px; color: #7D7D7D; font-family: &#39;Microsoft yahei&#39;, Arial, Helvetica, sans-serif; line-height: 26px; text-align: center;"><img src="/Public/Home/images/14813747193.png" alt="弹幕.gif"></span></p><p><span style="font-size: 18px; color: #7D7D7D; font-family: &#39;Microsoft yahei&#39;, Arial, Helvetica, sans-serif; line-height: 26px; text-align: center;"><br></span></p><p><span style="font-size: 18px; color: #7D7D7D; font-family: &#39;Microsoft yahei&#39;, Arial, Helvetica, sans-serif; line-height: 26px; text-align: center;">支持普通的弹幕横向飞过！</span></p><p style="text-align: center; "><span style="color:#7d7d7d;font-family:Microsoft yahei, Arial, Helvetica, sans-serif"><span style="font-size: 18px; line-height: 26px;">同时支持整个活动过程无缝对接弹幕，应用到所有场景！</span></span></p><p style="padding: 0px; margin: 0px; font-family: &#39;Microsoft yahei&#39;, Arial, Helvetica, sans-serif; font-size: 14px; line-height: 26px; color: rgb(125, 125, 125); text-align: center;"><br></p>		   </div>
        </div>
...
<a href="http://www.juxianchang.com/wxfunction/hudong/11.html#top" id="scrollUp"></a>
<script>
var companyId = 0;
