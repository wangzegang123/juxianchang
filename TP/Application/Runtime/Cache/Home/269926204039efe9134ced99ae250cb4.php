...
<div class="wrap" id="wrap"> 
  ...
  <div class="inner2 location clearfix">
    <div class="left">
     <a href="http://www.juxianchang.com/wxfunction/">功能服务</a> &gt; <a href="http://www.juxianchang.com/wxfunction/hudong/">互动</a> &gt;   <a href="http://www.juxianchang.com/wxfunction/hudong/63.html">疯狂数钱</a> 
    </div>
  ...
  <div class="inner2">
    <div class="column2 clearfix">
      <div class="column2-pic left js_funcPic">
        <div id="js_funcPicBig" class="swiper-container  gallery-top">
          ...
          <ul class="swiper-wrapper column2-pic-big">
                        <li class="swiper-slide"><img src="/Public/Home/images/20170822110007933.gif"></li>
                      </ul>
        </div>
      ...
      <div class="column2-con left">
        <h3>疯狂数钱 </h3>
        <p>聚现场微信墙，疯狂数钱游戏，参与者进入游戏界面后，手机上会显示一沓纸币，我们手指向上滑动手机屏幕，即可将钱滑出，大屏幕端会直接与现场游戏数据。</p>
        <p class="price">￥<span>800元/天</span></p>
		  <p style="display: block; font-size: 12px; color:red;text-decoration: line-through; margin: -3px 0 0;"><span>1200元/天</span></p>
    <div class="tag">
    ...
    <div class="clearfix">
      ...
      <div class="detail right">
          ...
          <ul class="left">
            <li><a href="http://www.juxianchang.com/wxfunction/hudong/63.html#jsDetailIntro">详情介绍</a></li>
      ...
      <div id="jsDetailIntro" class="detail-con">
          <div class="txt">
           <p style="margin-top: 0px; margin-bottom: 0px; white-space: normal; box-sizing: border-box; padding: 0px;"><br></p><p style="margin-top: 0px; margin-bottom: 0px; white-space: normal; box-sizing: border-box; padding: 0px;"><br></p><p style="margin-top: 0px; margin-bottom: 0px; white-space: normal; box-sizing: border-box; padding: 0px;"><br></p><p style="margin-top: 0px; margin-bottom: 0px; white-space: normal; box-sizing: border-box; padding: 0px;">常见问题解答：</p><p style="margin-top: 0px; margin-bottom: 0px; white-space: normal; box-sizing: border-box; padding: 0px;"><span style="box-sizing: border-box; color: #FF4D4D; font-weight: 600;">Q:数钱是怎么玩的？</span></p><p style="margin-top: 0px; margin-bottom: 0px; white-space: normal; box-sizing: border-box; padding: 0px;">A;数钱是一款大屏互动游戏，参与者进入游戏界面后，手机上会显示一沓纸币，我们手指向上滑动手机屏幕，即可将钱滑出，大屏幕端会直接与现场游戏数据连接，显示数钱数量最多的前3名参与者头像和微信昵称！游戏时间为30秒一轮，可重复玩。</p><p style="margin-top: 0px; margin-bottom: 0px; white-space: normal; box-sizing: border-box; padding: 0px;"><br></p><p style="margin-top: 0px; margin-bottom: 0px; white-space: normal; box-sizing: border-box; padding: 0px;">微信大屏幕端，可以自定义钱币的样式，背景音乐，体验现场互动个性定制化！</p><p><img src="/Public/Home/images/15033709588.png" style="box-sizing: border-box; border: 0px; vertical-align: middle; width: 883px;"></p><p><img src="/Public/Home/images/15033709594.png" style="box-sizing: border-box; border: 0px; vertical-align: middle; width: 883px;"></p><hr class="mTop-10" color="#EEEEEE" width="100%" style="box-sizing: content-box; height: 0px; margin: 10px 0px 0px; border-right: 0px; border-bottom: 0px; border-left: 0px; border-image: initial; border-top-style: solid; border-top-color: rgb(238, 238, 238); padding: 0px;"><p style="box-sizing: border-box; margin-top: 0px; margin-bottom: 0px; padding: 0px;"><br></p>		   </div>
        </div>
...
<a href="http://www.juxianchang.com/wxfunction/hudong/63.html#top" id="scrollUp"></a>
<script>
var companyId = 0;
