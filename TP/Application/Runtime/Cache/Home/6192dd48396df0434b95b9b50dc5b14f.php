...
<div class="wrap" id="wrap"> 
  ...
  <div class="inner2 location clearfix">
    <div class="left">
     <a href="http://www.juxianchang.com/wxfunction/">功能服务</a> &gt; <a href="http://www.juxianchang.com/wxfunction/hudong/">互动</a> &gt;   <a href="http://www.juxianchang.com/wxfunction/hudong/36.html">幸运号码</a> 
    </div>
  ...
  <div class="inner2">
    <div class="column2 clearfix">
      <div class="column2-pic left js_funcPic">
        <div id="js_funcPicBig" class="swiper-container  gallery-top">
          ...
          <ul class="swiper-wrapper column2-pic-big">
                        <li class="swiper-slide"><img src="/Public/Home/images/1481439571.gif"></li>
                      </ul>
        </div>
      ...
      <div class="column2-con left">
        <h3>幸运号码 </h3>
        <p>微信幸运号码抽取幸运号码，大奖就是你的啦。可以设置一次抽取1到10个幸运号码，给现场活动带来更多有趣和惊喜。</p>
        <p class="price">￥<span>200元/天</span></p>
    ...
    <div class="clearfix">
      ...
      <div class="detail right">
          ...
          <ul class="left">
            <li><a href="http://www.juxianchang.com/wxfunction/hudong/36.html#jsDetailIntro">详情介绍</a></li>
      ...
      <div id="jsDetailIntro" class="detail-con">
          <div class="txt">
           <h2 style="word-wrap: break-word; padding: 0px; margin: 50px 0px 15px; border: none; font-size: 46px; color: rgb(7, 155, 7); font-family: &#39;Microsoft YaHei&#39;, Helvitica, Verdana, Tohoma, Arial, san-serif; white-space: normal; text-align: center; background-color: rgb(255, 255, 255);">微信幸运号码<span style="word-wrap: break-word; padding: 0px; margin: 0px; border: none; font-size: 18px;"></span></h2><p class="text1" style="word-wrap: break-word; padding: 0px; margin-top: 0px; margin-bottom: 15px; border: none; font-size: 30px; color: rgb(102, 102, 102); font-family: &#39;Microsoft YaHei&#39;, Helvitica, Verdana, Tohoma, Arial, san-serif; white-space: normal; text-align: center; background-color: rgb(255, 255, 255);">抽取幸运号码，大奖就是你的啦。</p><p class="text2" style="word-wrap: break-word; padding: 0px; margin-top: 0px; margin-bottom: 15px; border: none; color: rgb(153, 153, 153); font-family: &#39;Microsoft YaHei&#39;, Helvitica, Verdana, Tohoma, Arial, san-serif; white-space: normal; text-align: center; background-color: rgb(255, 255, 255);"><span style="font-size: 20px;">可以设置一次抽取1到10个幸运号码，给现场活动带来更多有趣和惊喜。</span></p><p style="text-align: center;"><img src="/Public/Home/images/14814397109.png" alt="微信大屏幕抽奖,微信现场游戏" width="600" height="329" border="0" vspace="0" style="width: 600px; height: 329px;"></p><p><br></p>		   </div>
        </div>
...
<a href="http://www.juxianchang.com/wxfunction/hudong/36.html#top" id="scrollUp"></a>
<script>
var companyId = 0;
