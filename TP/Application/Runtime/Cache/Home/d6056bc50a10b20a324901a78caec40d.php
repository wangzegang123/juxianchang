    ...
    <div class="log-reg-v3 content-md">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-5">
                    <form id="sky-form1" class="log-reg-block sky-form" action="<?php echo U('Home/Lu/login');?>" enctype="multipart/form-data" method="post">
                        <h2>登录</h2>
                        <section>
                            <label class="input login-input no-border-top">
                                <input type="text" name="username" placeholder="请输入用户名" class="form-control" style="width:415px">
                            </label>
                        </section>
                        <section>
                            <label class="input login-input no-border-top">
                        ...
                        <button class="btn-u btn-u-sea-shop btn-block margin-bottom-20" type="submit">登录</button>
                    ...
                    <p class="text-center">您没有账号，那么您可以点击<a href="<?php echo U('Home/Lu/register');?>">注册</a></p>
                </div>
...
<script src="/tp/Public/assets/plugins/jquery/jquery.min.js"></script>
<script src="/tp/Public/assets/plugins/jquery/jquery-migrate.min.js"></script>
...
<!-- Login Form -->
<script src="/tp/Public/assets/plugins/sky-forms/version-2.0.1/js/jquery.form.min.js"></script>
<!-- Validation Form -->
<script src="/tp/Public/assets/plugins/sky-forms/version-2.0.1/js/jquery.validate.min.js"></script>
<!-- Scrollbar -->
<script src="/tp/Public/assets/plugins/scrollbar/src/jquery.mousewheel.js"></script>
...
<script src="/tp/Public/assets/js/forms/page_login.js"></script>
<script src="/tp/Public/assets/js/forms/page_contact_form.js"></script>
