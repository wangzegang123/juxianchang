    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-9 col-lg-10 sys_menu_box">
            ...
            <ul class="nav nav-tabs">
                <li>
                    <a href="<?php echo U('activity_person');?>"><i class="fa fa-file"></i> 全部活动</a>
                </li>
                <li>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form action="<?php echo U('activity_notstart');?>" method="get" class="form-horizontal" role="form" id="form1">
