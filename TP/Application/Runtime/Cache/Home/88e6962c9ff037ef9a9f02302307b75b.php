  ...
  <div class="container clearfix">
    <div class="casedetail casedetail-type1">
      <div class="case-part1 clearfix">
        <div class="textdetail">
            <h1>微信墙怎么开通_微信上墙怎么申请对接？【视频教程】</h1>
            <div class="shop-d">
              <center> <span class="date-act">来源：</span>&nbsp;&nbsp;&nbsp;<span>更新时间：2016-12-12</span></center> 
                          </div>
	...
	<!--end .case-part1-->
      ...
      <div class="case-part2 clearfix">
        <div class="textbox ">
          <div class="textdetail">
            <p></p><p style="text-align: center;"><span style="font-size: 20px; color: #00B0F0;"><strong>微信公众平台与聚现场微信大屏幕互动教程</strong></span>&nbsp;</p><p style="text-align: center;">不清楚的地方请联系QQ客服！</p><p style="text-align: center;"><embed src="http://www.tudou.com/v/QpuzSOetmDY/&amp;bid=05&amp;rpid=901506983&amp;resourceId=901506983_05_05_99/v.swf" type="application/x-shockwave-flash" allowscriptaccess="always" allowfullscreen="true" wmode="opaque" width="480" height="400" id="__wow_video_player__-751898615" title="Adobe Flash Player"></p><p></p>
          </div>

		
                   <!--	<div class="article_bm">【<a href="#">返回顶部</a>】 【<a href="javascript:window.print()">打印此页</a>】 【<a href="#" onclick="javascript:window.close();">关闭</a>】</div>
                          -->  <ul class="news_other">
                                <li class="pre">上一篇：<a href="<?php echo U('six');?>">怎么做？【新手必看】</a> </li>
                                <li class="next">下一篇：<a href="<?php echo U('lk');?>">怎么做微信摇一摇_如何进行现场微信抽奖？【视频教程】</a> </li>
                            </ul> 
       </div>
          </div>
        </div>
