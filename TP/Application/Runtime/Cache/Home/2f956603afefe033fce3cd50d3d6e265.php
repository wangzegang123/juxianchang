...
<div class="header">
    <div class="inner clearfix">
        <h1 class="logo left">
            <a href="<?php echo U('Home/Index/index');?>">微信大屏幕</a>
            <a href="<?php echo U('Home/Index/index');?>" class="btn-back">回首页</a>      </h1>
  ...
  <div class="container clearfix">
    <div class="casedetail casedetail-type1">
      <div class="case-part1 clearfix">
        <div class="textdetail">
            <h1>做微信大屏幕互动时，怎样让用户关注公众号参与互动！</h1>
            <div class="shop-d">
	...
	<!--end .case-part1-->
      <div class="case-part2 clearfix">
        <div class="textbox ">
          <div class="textdetail">
            <p></p><p>&nbsp; &nbsp; 很多客户希望在做微信摇一摇，微信抽奖，留言墙的时候，能够吸引更多的粉丝来关注自己的平台才能参与互动！确实，做微信大屏幕互动，是一个吸收粉丝非常不错的方法，由其是在当前，各种严格条件下，动不动就容易被躺枪封号，微信大屏幕作为一个活动周期短，互动性强的应用，可以十分有效的解决客户的这些困扰。</p><p>&nbsp; &nbsp; 我们来看看，微信大屏幕互动的优势。</p><p>&nbsp; &nbsp; 1.丰富活动性，微信大屏幕有各种花样的玩法，例如摇一摇，红包雨，微信弹幕，微信墙，微信大屏幕表白等。</p><p>&nbsp; &nbsp; 2.氛围墙，一个简单的微信摇一摇互动，在活动的中间环节发起，能够引爆全场。</p><p>&nbsp; &nbsp; 3.简单性，不需要过多的人力物力，简单到只需一个人就能hold住全场，比起传统的游戏，省时省力省经费。</p><p>&nbsp; &nbsp; 4.营销性，如果你觉得微信大屏幕互动仅仅是一个游戏，那么你就错了。商家首先可以利用他来解决活动的刚需，其次他能够为商家引导粉丝关注，进行二次营销，同时也能支持现场互动营销，例如现场大屏幕拍卖，大屏幕订货打赏，酒吧大屏幕互动。</p><p><br></p><p>&nbsp; &nbsp; 简单的介绍了下大屏幕的好处，现在来看下如何通过聚现场互动来为商家吸引粉丝？也就是如何让用户实现关注后才能参与互动。</p><p>&nbsp;1.进入到聚现场的活动管理，选择你需要用户关注才能参与的活动，点击活动链接。</p><p style="text-align: center;"><img src="/Public/Home/images/14975846353.png" alt="微信签到 微信墙 微信互动 摇一摇红包雨" width="720" height="226" border="0" vspace="0" style="width: 720px; height: 226px;"></p><p>复制带 微信xxxx地址的那串链接， 然后粘贴到你的公众号的自定义菜单里或者关键词回复中。</p><p><br></p><p>自定义菜单方式：公众号的自定义菜单 可以直接登录 <a href="http://mp.weixin.qq.com/" _src="http://mp.weixin.qq.com">http://mp.weixin.qq.com</a>&nbsp;微信官方管理后台进行操作管理，如果您托管了第三方，可以到您托管的第三方进行操作管理。</p><p><br></p><p>关键词回复方式：同样，登录微信官方的管理后台，添加关键词回复， 将关键词设置成为您想要的，例如“签到” 然后内容里编辑如下： &lt;a href="你的活动链接"&gt; 点击这里进行签到/互动/摇一摇&lt;/a&gt;</p><p><br></p><p>最后，在聚现场微信墙活动管理的基础设置里， 将您的微信公众号二维码上传上去即可。</p><p style="text-align: center;"><img src="/Public/Home/images/1497584635.png" alt="聚现场 微信大屏幕 微信签到 摇一摇" width="720" height="277" border="0" vspace="0" style="width: 720px; height: 277px;"></p><p></p>
          </div>

                   <!--	<div class="article_bm">【<a href="#">返回顶部</a>】 【<a href="javascript:window.print()">打印此页</a>】 【<a href="#" onclick="javascript:window.close();">关闭</a>】</div>
                          -->  <ul class="news_other">
                                <li class="pre">上一篇：<a href="<?php echo U('lktwo');?>">聚现场微信墙新功能推出：签到验证+微信签到美化背景+签到后返回座位信息等</a> </li>
                                <li class="next">下一篇：<a href="<?php echo U('index3');?>">最后一页</a> </li>
                            </ul>
        </div>
        <!--end:左侧-->
      </div><!--end .case-part2-->
...
<script type="text/javascript" src="http://www.juxianchang.com/api.php?op=count&id=119&modelid=1"></script>-->
</div> <!-- wrap end-->
...
<div class="related-case clearfix">
        ...
        <div class="related-cases-list2">
            <div class="swiper-container swiper-container-horizontal">
                <ul id="caseList2" class="swiper-wrapper clearfix" style="transition-duration: 0ms; transform: translate3d(-260px, 0px, 0px);"><li class="swiper-slide swiper-slide-duplicate swiper-slide-prev" data-swiper-slide-index="1" style="width: 260px;">
                    ...
                    <span class="pic"> <a href="<?php echo U('Index/index_case1');?>" target="_blank"><img src="/Public/Home/images/1478527513.jpg" alt="福建商会年会微信上墙活动场面火爆"></a></span>
                    ...
                    <li class="swiper-slide swiper-slide-active" data-swiper-slide-index="0" style="width: 260px;">
                        ...
                        <span class="pic"> <a href="<?php echo U('Index/index_case2');?>" target="_blank"><img src="/Public/Home/images/thumb_456_215_20150129092431292.jpeg" alt="兰姬妮微商代理招商会"></a></span>
                    ...
                    <li class="swiper-slide swiper-slide-next" data-swiper-slide-index="1" style="width: 260px;">
                        <span class="pic"> <a href="<?php echo U('Index/index_case3');?>" target="_blank"><img src="/Public/Home/images/1478527513.jpg" alt="福建商会年会微信上墙活动场面火爆"></a></span>
                        <span class="title"><a href="http://www.juxianchang.com/xinwen/58.html" title="福建商会年会微信上墙活动场面火爆" target="_blank" style="color:#42566c;">福建商会年会微信上墙活动场面火爆</a></span>
                    </li>
                    <li class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="0" style="width: 260px;">

                        <span class="pic"> <a href="<?php echo U('Index/index_case1');?>" target="_blank"><img src="/Public/Home/images/thumb_456_215_20150129092431292.jpeg" alt="兰姬妮微商代理招商会"></a></span>
                        <span class="title"><a href="http://www.juxianchang.com/xinwen/59.html" title="兰姬妮微商代理招商会" target="_blank" style="color:#42566c;">兰姬妮微商代理招商会</a></span>
                    </li></ul>
            </div>
            <div class="txtcenter">
    ...
    <div class="cases-about2 right">
        ...
        <ul class="related-case-list">
            <li class="clearfix">
                <a href="<?php echo U('Home/Index/index_case1');?>" class="case-img2"><img src="/Public/Home/images/20171030010804910.jpg" alt=""></a>
                <p class="words-right">
