...
<div id="login" class="login-container" style="justify-content: center; align-items: center; display: -webkit-flex;">
    <div class="warning-1" style="display: none; opacity: 1;"></div>
    ...
    <div class="login-box">
        ...
        <div id="embed-captcha" style="margin-left:20px;opacity:0.5;">
            ...
            <div class="common-login login-submit"><input type="submit" value="登录" id="embed-submit"> <input name="token" value="wRPp" type="hidden"></div>
        <div class="register-link">
                还没有账号？点击
            <input type="button" value="注册" id="reg" />
                <!--<a href="<?php echo U('home/login/register');?>"  style="color: red;" >注册</a>-->
        </div>
    </div>
