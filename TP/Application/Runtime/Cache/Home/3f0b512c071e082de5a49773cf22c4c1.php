...
<div class="wrap" id="wrap"> 
  ...
  <div class="inner2 location clearfix">
    <div class="left">
     <a href="http://www.juxianchang.com/wxfunction/">功能服务</a> &gt; <a href="http://www.juxianchang.com/wxfunction/hudong/">互动</a> &gt;   <a href="http://www.juxianchang.com/wxfunction/hudong/18.html">对对碰</a> 
    </div>
  ...
  <div class="inner2">
      ...
      <div class="column2-pic left js_funcPic">
        <div id="js_funcPicBig" class="swiper-container  gallery-top">
          ...
          <ul class="swiper-wrapper column2-pic-big">
                        <li class="swiper-slide"><img src="/Public/Home/images/1498828426.gif"></li>
                      </ul>
        </div>
    ...
    <div class="tag">
		                 <li><a href="http://www.juxianchang.com/wxfunction/hudong/18.html#" target="_blank">组合使用 200元</a></li>
				        <li><a href="http://www.juxianchang.com/wxfunction/hudong/18.html#" target="_blank">单独使用 300元</a></li>
    ...
    <div class="clearfix">
      ...
      <div class="detail right">
          ...
          <ul class="left">
            <li><a href="http://www.juxianchang.com/wxfunction/hudong/18.html#jsDetailIntro">详情介绍</a></li>
      ...
      <div id="jsDetailIntro" class="detail-con">
          <div class="txt">
           <p>随机抽取两个人进行现场互动。可抽取多对后进行互动<img src="/Public/Home/images/1498828426.gif" alt="微信大屏幕 微信签到 现场摇一摇" width="400" height="224" border="0" vspace="0" style="width: 400px; height: 224px;"></p>		   </div>
        </div>
...
<a href="http://www.juxianchang.com/wxfunction/hudong/18.html#top" id="scrollUp"></a>
<script>
var companyId = 0;
