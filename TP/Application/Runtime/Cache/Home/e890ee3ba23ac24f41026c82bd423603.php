...
<head>
    ...
    <link rel="stylesheet" href="/tp/Public/assets/plugins/bootstrap/css/bootstrap.min.css">
    <link rel="stylesheet" href="/tp/Public/assets/css/shop.style.css">
     
    <!-- CSS Implementing Plugins -->
    <link rel="stylesheet" href="/tp/Public/assets/plugins/line-icons/line-icons.css">
    <link rel="stylesheet" href="/tp/Public/assets/plugins/font-awesome/css/font-awesome.min.css">
    <link rel="stylesheet" href="/tp/Public/assets/plugins/scrollbar/src/perfect-scrollbar.css">
    <!-- <link rel="stylesheet" href="/tp/Public/assets/plugins/sky-forms/version-2.0.1/css/sky-forms.css"> -->
    <link rel="stylesheet" href="/tp/Public/assets/css/pages/log-reg-v3.css">
    
    <!-- Style Switcher -->
    <link rel="stylesheet" href="/tp/Public/assets/css/plugins/style-switcher.css">

    <!-- CSS Theme -->
    <link rel="stylesheet" href="/tp/Public/assets/css/theme-colors/default.css" id="style_color">

    <!-- CSS Customization -->
    <link rel="stylesheet" href="/tp/Public/assets/css/custom.css">
</head> 
            ...
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html">
                        <img id="logo-header" src="/tp/Public/assets/img/logo.png" alt="Logo">
                    </a>
                </div>
                    ...
                    <ul class="list-inline shop-badge badge-lists badge-icons pull-right">
                        <li>
                            ...
                            <ul id="scrollbar" class="list-unstyled badge-open contentHolder">
                                <li>
                                    <img src="/tp/Public/assets/img/thumb/01.jpg" alt="">
                                ...
                                <li>
                                    <img src="/tp/Public/assets/img/thumb/02.jpg" alt="">
                                    <button type="button" class="close">×</button>
                                    <div class="overflow-h">
                                        <span>Black Glasses</span>
                                        <small>1 x $400.00</small>
                                ...
                                <li>
                                    <img src="/tp/Public/assets/img/thumb/03.jpg" alt="">
                                    <button type="button" class="close">×</button>
                                    <div class="overflow-h">
                                        <span>Black Glasses</span>
                                        <small>1 x $400.00</small>
                                        ...
                                        <div class="container">
                                            <div class="row">
                                                ...
                                                <div class="col-md-3 col-sm-4 col-xs-4 md-margin-bottom-30">
                                                    <a href="#"><img class="product-offers img-responsive" src="/tp/Public/assets/img/blog/01.jpg" alt=""></a>
                                                </div>
                                                <div class="col-md-3 col-sm-4 col-xs-4 sm-margin-bottom-30">
                                                    <a href="#"><img class="product-offers img-responsive" src="/tp/Public/assets/img/blog/02.jpg" alt=""></a>
                                                </div>
                                                <div class="col-md-3 col-sm-4 col-xs-4">
                                                    <a href="#"><img class="product-offers img-responsive" src="/tp/Public/assets/img/blog/03.jpg" alt=""></a>
                                                </div>
                                            </div><!--/end row-->
                                        </div><!--/end container-->
            ...
            <div class="row">
                <div class="col-md-7 md-margin-bottom-50">
                    ...
                    <div class="members-number">
                        ...
                        <img class="img-responsive" src="/tp/Public/assets/img/map.png" alt="">
                    </div>    
                </div>

                <div class="col-md-5">
                    <form id="sky-form4" class="log-reg-block sky-form" action="<?php echo U('Home/Lu/register');?>" method="post" enctype="multipart/form-data">
                        <h2>注册</h2>
...
<!--                            <section>
                                <label class="input login-input">
                                    <div class="input-group">
                                        ...
                                        <input type="email" placeholder="请输入账号" name="uname" class="form-control">
                                    </div>
                                </label>
                            </section>-->
                            <!--<div class="row">
...
<!--                            <section>
                            ...
                            <tr height="50">
                                ...
                                <td><input id="mobile" name="mobile" type="text" size="25" style="color:#000" />
                                    <input id="code1" type="hidden" value="<?php echo ($send_code); ?>"/>
                                    <!--<input id="zphone" style="color:#000" type="" value=" 获取手机验证码 " onClick="get_mobile_code()">-->
                            ...
                            <tr height="50">
                                ...
                                <td> <input type="text" size="8" id="mobile_code" name="mobile_code" class="inputBg" style="color:black"/>
                                </td>
                            </tr>
                                </section>
                        ...
                        <button class="btn-u btn-u-sea-shop btn-block margin-bottom-20" type="submit">注册</button>
                    </form>
</div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4 md-margin-bottom-40">
                        <a href="index.html"><img class="footer-logo" src="/tp/Public/assets/img/logo-2.png" alt=""></a>
...
<script src="/tp/Public/assets/layer/layer.js" type="text/javascript"></script>
<!-- JS Global Compulsory -->
<script src="/tp/Public/assets/plugins/jquery/jquery-1.8.3.min.js"></script>

<script src="/tp/Public/assets/plugins/bootstrap/js/bootstrap.min.js"></script>
<!--<script src="/tp/Publichome/layer/layer.js" type="text/javascript"></script>
<script src="/tp/Publichome/js/jquery-1.9.1.min.js" type="text/javascript"></script>-->
<!-- JS Implementing Plugins -->
<script src="/tp/Public/assets/plugins/back-to-top.js"></script>
<!-- Validation Form -->
<script src="/tp/Public/assets/plugins/sky-forms/version-2.0.1/js/jquery.validate.min.js"></script>
<!-- Scrollbar -->

<script src="/tp/Public/assets/plugins/scrollbar/src/perfect-scrollbar.js"></script>
<!-- JS Customization -->
<script src="/tp/Public/assets/js/custom.js"></script>
<!-- JS Page Level -->           
<script src="/tp/Public/assets/js/shop.app.js"></script>
<script src="/tp/Public/assets/js/forms/page_registration.js"></script>
<script type="text/javascript" src="/tp/Public/assets/js/plugins/style-switcher.js"></script>
<script>
...
<!--[if lt IE 9]>
    <script src="/tp/Public/assets/plugins/respond.js"></script>
    <script src="/tp/Public/assets/plugins/html5shiv.js"></script>
    <script src="/tp/Public/assets/js/plugins/placeholder-IE-fixes.js"></script>    
    <script src="/tp/Public/assets/plugins/sky-forms/version-2.0.1/js/sky-forms-ie8.js"></script>
<![endif]-->
<!--[if lt IE 10]>
    <script src="/tp/Public/assets/plugins/sky-forms/version-2.0.1/js/jquery.placeholder.min.js"></script>
<![endif]-->
</body>
