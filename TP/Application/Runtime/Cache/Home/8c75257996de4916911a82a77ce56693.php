    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-9 col-lg-10 sys_menu_box">
            ...
            <ul class="nav nav-tabs">
                ...
                <li>
                    <a href="<?php echo U('Lk/shezhi');?>"></i> 账户设置</a>
                </li>
            </ul>
                        ...
                        <div class="account-money pull-left">
                            <ul class="list-unstyled pull-left v-align-t">
                                ...
                                <li>
                                    ...
                                    <p>已提现（元）<span class="label label-danger">含手续费、不含礼物分成</span></p>
                                </li>
                            </ul>
                        </div>
            ...
            <script language="javascript" type="text/javascript">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">提现明细</div>
                    <div class="panel-body">
                        <table class="table table-hover" style="display:auto;">
                            <form action="" method="post" class="form-horizontal" role="form" ng-controller="formCtrl" id="form2" enctype="multipart/form-data">
                            ...
                            <tbody><tr>
                                ...
                                <td colspan="12">
                                    <a href="<?php echo U('Lk/export');?>">导出所有数据</a>
    ...
    <div id="divFloatToolsView" class="floatR" style="display: none;min-height:237px;width: 140px;">
        <div class="cn">
            ...
            <ul style="min-height:237px;">
                <li><span>赞木</span> <a target="_blank" href="http://wpa.qq.com/msgrd?v=3&amp;uin=284099857&amp;site=qq&amp;menu=yes"><img border="0" src="./online.png" alt="点击这里给我发消息" title="点击这里给我发消息" onerror=""></a> </li>
