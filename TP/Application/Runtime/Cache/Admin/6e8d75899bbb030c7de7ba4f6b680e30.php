...
<!-- saved from url=(0097)http://wall.juxianchang.com/web/index.php?c=site&a=entry&op=security&do=my_home&m=meepo_xianchang -->
<html lang="zh-cn"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><style type="text/css">@charset "UTF-8";[ng\:cloak],[ng-cloak],[data-ng-cloak],[x-ng-cloak],.ng-cloak,.x-ng-cloak,.ng-hide:not(.ng-hide-animate){display:none !important;}ng\:form{display:block;}.ng-animate-shim{visibility:hidden;}.ng-anchor{position:absolute;}</style>
    ...
    <script type="text/javascript">
        ...
        window.sysinfo = {
            ...
            'siteurl': 'http://wall.juxianchang.com/web/index.php?c=site&a=entry&op=security&do=my_home&m=meepo_xianchang',
    ...
    <script>var require = { urlArgs: 'v=20180104163450' };</script>
...
<body class="zh_CN">
        ...
        <div class="col-xs-12 col-sm-9 col-lg-10 sys_menu_box">
            <ul class="nav nav-tabs">
                <li>
                    <a href="<?php echo U('personal_center');?>"><i class="fa fa-cog"></i> 基本信息</a>
                </li>
                <li class="active">
                    <a href=""><i class="fa fa-lock"></i> 安全中心</a>
                </li>
            </ul>
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10 col-xs-12">
                                <input id="oldpassword" name="old_pwd" type="password" class="form-control" autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10 col-xs-12">
                                <input id="password" name="new_pwd" type="password" class="form-control" autocomplete="off" value="">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10 col-xs-12">
                                <input id="repassword" name="re_pwd" type="password" class="form-control" value="" autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6 col-md-8 col-xs-12">
                                <input type="submit" value="确认" class="btn btn-primary col-lg-1">
...
<a href="http://wall.juxianchang.com/web/index.php?c=site&amp;a=entry&amp;op=security&amp;do=my_home&amp;m=meepo_xianchang#" title="返回顶部" id="goto-top"></a>
