...
<html lang="zh-cn"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><style type="text/css">@charset "UTF-8";[ng\:cloak],[ng-cloak],[data-ng-cloak],[x-ng-cloak],.ng-cloak,.x-ng-cloak,.ng-hide:not(.ng-hide-animate){display:none !important;}ng\:form{display:block;}.ng-animate-shim{visibility:hidden;}.ng-anchor{position:absolute;}</style>
    ...
    <!--my css-->
    <link rel="stylesheet" href="/Public/admin/css/common(1).css">
    <link rel="stylesheet" href="/Public/admin/css/sys.css">
    <link rel="stylesheet" href="/Public/admin/css/style.css">
    <link rel="stylesheet" href="/Public/admin/css/spinners.css" type="text/css">
    <link rel="stylesheet" href="/Public/admin/css/animate.min.css" type="text/css">
    ...
    <script type="text/javascript" src="/Public/admin/js/jquery-1.11.1.min.js.下载"></script>
    <script type="text/javascript" src="/Public/admin/js/util.js.下载"></script>
    <script type="text/javascript" src="/Public/admin/js/common.min.js.下载"></script>
    <script type="text/javascript" src="/Public/admin/js/require.js.下载"></script>
    <script type="text/javascript" src="/Public/admin/js/config.js.下载"></script>
    <style>
    ...
    <!---默认-->
    <script type="text/javascript" charset="utf-8" async="" data-requirecontext="_" data-requiremodule="jquery" src="/Public/admin/js/jquery-1.11.1.min.js(1).下载"></script><script type="text/javascript" charset="utf-8" async="" data-requirecontext="_" data-requiremodule="bootstrap" src="/Public/admin/js/bootstrap.min.js.下载"></script></head>
<body class="zh_CN">

<div class="meepo_head">
    <div class="meepo_head_box">
        <div class="meepo_inner">
            <div class="meepo_logo"><a href="http://wall.juxianchang.com/web/index.php?c=site&amp;a=entry&amp;do=my_home&amp;m=meepo_xianchang#"></a></div>
            ...
            <div class="meepo_accounts">
                <div class="acounts_box dropdown" style="">
                    <a href="javascript:;" class="dropdown-toggle accounts_box_a" data-toggle="dropdown">
                        <img class="avatar" src="/Public/admin/images/avatar_7.jpg" onerror="">
                        <span class="username">你好、LZ123456</span><i class="fa fa-angle-down"></i>
                    </a>
                    <ul class="dropdown-menu account_menu">
                        <li><a href=""><i class="fa fa-user"></i> 个人中心</a></li>
                        <li style="border-bottom: 1px solid #e4e4e4;"><a href=""><i class="fa fa-money"></i> 我的收入</a></li>
                        <li style="border-bottom: 1px solid #e4e4e4;"><a href=""><i class="fa fa-money"></i> 红包账户</a></li>
        ...
        <div class="col-xs-12 col-sm-3 col-lg-2 sys_menu_box">
            <div class="sys_menu">
                <div class="sys-menu-user" style="border-bottom: 1px solid #e9e9e9;">
                    <div>
                        <div class="avatar">
                            <a href="http://wall.juxianchang.com/web/index.php?c=site&amp;a=entry&amp;do=my_home&amp;m=meepo_xianchang"><img src="/Public/admin/images/avatar_7.jpg" onerror=""></a>
                        </div>
                        <i class="elem"></i>
                    </div>
                    <h3 class="name"><a href="">LZ123456</a></h3>
                    <!--<p>普通用户</p>-->
                    <p><a id="agent_gl" href="" class="btn-agency">个人中心</a></p>
                </div>
                ...
                <ul class="sys-menu-menu">
                    <li>
                        ...
                        <ul class="level2">
                            <li class="curr"><a href="">我的活动</a></li>
                        </ul>
                    </li>
                    <li>
    ...
    <div id="divFloatToolsView" class="floatR" style="display: none;min-height:237px;width: 140px;">
        <div class="cn">
            ...
            <ul style="min-height:237px;">
                <li><span>赞木</span> <a target="_blank" href=""><img border="0" src="/Public/admin/images/online.png" alt="点击这里给我发消息" title="点击这里给我发消息" onerror=""></a> </li>
